...
d1 = np.load("../distances/21/1/distance_matrix_T22_4_1s_100ms.npy")
d2 = np.load("../distances/21/1/distance_matrix_T26_0_1s_100ms.npy")
d3 = np.load("../distances/21/1/distance_matrix_T27_6_1s_100ms.npy")
...
# similar_count1 = 0;
# similar_count2 = 0;
# sM = thresholdMatrix(1/(dM+0.1), 800)
# for i in range(0, sM.shape[0]):
#   r = sM[i, :]
#   r = np.nonzero(r)
#   r = r[0]
