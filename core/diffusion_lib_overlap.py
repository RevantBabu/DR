...
#d2 = np.load("../distances/21/1/distance_matrix_T22_1_1s_20ms.npy")
d3 = np.load("../distances/21/1/distance_matrix_T22_2_1s_20ms.npy")
d4 = np.load("../distances/21/1/distance_matrix_T22_3_1s_20ms.npy")
...
fig = plt.figure(figsize=(9,9))
ax = plt.subplot(111)
ax.plot(coords[:, 0][300:400], 'o-', label="Target neurons")
ax.plot(cornerIdx1[300:400], 'o', label="Corner1")
ax.plot(cornerIdx2[300:400], 'o', label="Corner2")
ax.plot(cornerIdx3[300:400], 'o', label="Corner3")
ax.plot(cornerIdx4[300:400], 'o', label="Corner4")
plt.title('DM_lib Dimensions')
plt.xlabel('dimension1')
plt.ylabel('dimension2')
ax.legend(loc='lower left',  shadow=True, ncol=1)#bbox_to_anchor=(0.75, 1.075),
#plt.savefig('../results/dm/21/1/test_dmlib_ev1.svg', format="svg")
plt.savefig('../results/21/1/dmev1_overlap_300.png')