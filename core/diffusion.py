...
ax = plt.subplot(111)
ax.plot(vSorted[1], 'o', label="Target neurons")#, markersize=0.4)
...
plt.savefig('../results/' + sys.argv[1] + "_leadingVector.svg", format="svg")
#plt.savefig('../results/all_leadingVector.svg', format="svg")
