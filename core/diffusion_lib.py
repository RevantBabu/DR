...
coords = embedding.fit( thresholdMatrix(1/(dM+0.1), 800) ).embedding_
...
plt.savefig('../results/21/1/dmev1.pdf')

fig = plt.figure(figsize=(9,9))
ax = plt.subplot(111)
ax.plot(coords[:, 1]*1000, 'o-', label="Target neurons")
...
plt.savefig('../results/21/1/dmev2.pdf')
...
plt.savefig('../results/21/1/dm3d.pdf')